...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
	{
		className: 'border-sky-100 bg-sky-25/90 dark:border-sky-900 dark:bg-sky-950/90',
		title: 'TubeOnAI',
	...
	{
		className: 'border-indigo-100 bg-indigo-25/90 dark:border-indigo-900 dark:bg-indigo-950/90',
		title: 'Templately',
	...
	{
		className: 'border-blue-100 bg-blue-25/90 dark:border-blue-900 dark:bg-blue-950/90',
		title: 'xCloud',
	...
	{
		className: 'border-green-100 bg-green-25/90 dark:border-green-900 dark:bg-green-950/90',
		title: 'Betterdocs',
	...
	{
		className: 'border-cyan-100 bg-cyan-25/90 dark:border-cyan-900 dark:bg-cyan-950/90',
	...
	{
		className: 'border-teal-100 bg-teal-25/90 dark:border-teal-900 dark:bg-teal-950/90',
		title: 'NotificationX',
	...
	{
		className: 'border-violet-100 bg-violet-25/90 dark:border-violet-900 dark:bg-violet-950/90',
		title: 'Easy.Jobs',
	...
	{
		className: 'border-emerald-100 bg-emerald-25/90 dark:border-emerald-900 dark:bg-emerald-950/90',
		title: 'SchedulePress',
	...
	{
		className: 'border-fuchsia-100 bg-fuchsia-25/90 dark:border-fuchsia-900 dark:bg-fuchsia-950/90',
		title: 'BetterLinks',
