...
const PhotoCard = () => {
	return (
		<div className='border-info/20 bg-light/10 pointer-events-none absolute bottom-[-4em] left-[-4em] flex w-[22em] flex-col items-start rounded-[2.25em] border-[0.05em] border-solid p-[1em] backdrop-blur-sm transition-transform delay-500 duration-1000 ease-in-out select-none group-hover/about-screen:translate-x-[-1em] dark:bg-slate-900/10'>
