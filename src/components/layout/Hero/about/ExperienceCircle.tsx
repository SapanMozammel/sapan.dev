...
const ExperienceCircle = () => {
	...
	return (
		<div className='border-info/50 bg-light/70 pointer-events-none absolute top-[12.5em] -right-[4em] aspect-square size-[12em] translate-x-1/2 rounded-full border-[0.05em] border-solid backdrop-blur select-none dark:bg-slate-900/70'>
