	...
	<section className='relative z-1 py-8 sm:py-12 lg:py-16'>
		<SectionSeparator lts rts lbs rbs tl bl ll rl>
			<div className='container'>
				<div className='dark:bg-dark bg-secondary border-primary/10 dark:border-success/15 relative z-10 mx-auto max-w-5xl overflow-hidden rounded-2xl border shadow-[0_8px_40px_-12px_color-mix(in_srgb,var(--color-primary)_20%,transparent),0_2px_12px_color-mix(in_srgb,var(--color-success)_10%,transparent)] dark:shadow-[0_8px_40px_-12px_color-mix(in_srgb,var(--color-primary)_25%,transparent),0_2px_12px_color-mix(in_srgb,var(--color-success)_15%,transparent)]'>
					<CtaBackground />
					<div className='relative z-10 flex flex-col items-center gap-3 p-8 text-center sm:gap-4 sm:p-12 lg:p-16'>
						...
						<h2 className='font-cg text-3xl !leading-tight font-medium tracking-wider text-black sm:text-5xl dark:text-white'>
							Have a project in mind?
							<br />
							<span className='font-eb text-primary dark:text-success tracking-tight'>Let&apos;s build it together.</span>
						</h2>
