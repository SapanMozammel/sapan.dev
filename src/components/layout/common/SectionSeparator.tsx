	...
	return (
		<>
			<div className={cn('section-separator pointer-events-none select-none', className)} {...rest}>
				{lts ? <IconPlus stroke={6} className={cn(STAR_CLASSES, 'absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2')} /> : null}
				...
				{rbs ? <IconPlus stroke={6} className={cn(STAR_CLASSES, 'absolute right-0 bottom-0 translate-x-1/2 translate-y-1/2')} /> : null}
