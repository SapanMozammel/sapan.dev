		...
		<form onSubmit={onSubmit} className='flex flex-col gap-4' noValidate>
			<div className='flex flex-col gap-4 sm:flex-row'>
				<fieldset className='flex flex-1 flex-col gap-2'>
					<label className='font-hg text-secondary-500 dark:text-secondary-500 text-sm leading-none font-medium tracking-wider uppercase'>Name</label>
					...
					{errors.name ? <p className='font-dm text-danger text-xs leading-none'>{errors.name}</p> : null}
				</fieldset>
				<fieldset className='flex flex-1 flex-col gap-2'>
					<label className='font-hg text-secondary-500 dark:text-secondary-500 text-sm leading-none font-medium tracking-wider uppercase'>Email</label>
					...
					{errors.email ? <p className='font-dm text-danger text-xs leading-none'>{errors.email}</p> : null}
				</fieldset>
			</div>
			<fieldset className='flex flex-col gap-2'>
				<label className='font-hg text-secondary-500 dark:text-secondary-500 text-sm leading-none font-medium tracking-wider uppercase'>Title</label>
				...
				{errors.title ? <p className='font-dm text-danger text-xs leading-none'>{errors.title}</p> : null}
			</fieldset>
			<fieldset className='flex flex-col gap-2'>
				<label className='font-hg text-secondary-500 dark:text-secondary-500 text-sm leading-none font-medium tracking-wider uppercase'>Message</label>
				<textarea
					name='message'
					value={form.message}
					onChange={onChange}
				...
				/>
				{errors.message ? <p className='font-dm text-danger text-xs leading-none'>{errors.message}</p> : null}
			</fieldset>
