...
const Logo = (props: React.SVGProps<SVGSVGElement>) => (
	<svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 512 512' {...props}>
		<path
			...
			d='M159.988 334.386c16.47 16.819 43.176 16.819 59.649 0 16.47-16.81 16.47-44.08 0-60.893l-86.708-88.741-31.009-31.661c-16.473-16.816-43.18-16.818-59.649 0-16.368 17.3-16.355 42.862 0 59.748l75.563 78.096z'
		/>
		<path
			fill='url(#paint1_linear_1599_136)'
			d='M229.65 22.612c-16.473-16.819-43.179-16.813-59.649 0L42.271 153.09c-16.368 17.302-16.355 42.862 0 59.748l75.563 78.096c-40.494-41.852 15.095-106.183 15.095-106.183l96.721-101.24c16.464-16.818 16.469-44.085 0-60.9'
		/>
		<path
			fill='url(#paint2_linear_1599_136)'
			d='M352.012 177.614c-16.47-16.819-43.176-16.819-59.649 0-16.47 16.81-16.47 44.08 0 60.893l86.708 88.741 31.009 31.661c16.473 16.816 43.179 16.818 59.649 0 16.367-17.3 16.355-42.862-.001-59.748l-75.562-78.096z'
		/>
		<path
			fill='url(#paint3_linear_1599_136)'
